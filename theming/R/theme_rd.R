...
#
# STATUS: canonical R theme file - real/in-use. rd_colours mirrors
# theming/palette.yaml's qualitative palette; keep the two in sync by hand
# if either changes (palette.yaml can't be loaded at runtime here).
#
...
#
# Usage: source this file directly (locally, or via its raw GitHub URL) at
# the top of a script/project - nothing else required.
#
# Example:
#   source("theme_rd.R")
